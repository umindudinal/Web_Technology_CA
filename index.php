...
<body>
   ...
   <div class="container">
      ...
      $query = "SELECT * FROM all_events ORDER BY created_at DESC LIMIT 3";
            ...
            <div class="item">
               <div class="image">
                  <?php if (file_exists($imagePath)) { ?>
                     <img src="<?= $imagePath ?>" alt="Event Image" width="200px">
                  <?php } else { ?>
               ...
               <div class="content">
                  ...
                  <ul>
                     <li>Event Code: <?= htmlspecialchars($row['event_code']) ?></li>
                  </ul>
                  <div class="bottom">
                     <div class="location"><i class="fa-solid fa-location-dot"></i> <?= htmlspecialchars($row['venue']) ?></div>
                     <div class="favorit">
                        <?php 
                        if ($userRole !== "Admin") { 
                           if ($authenticated) { ?>
                              <p>You want to Register Goto Event Page</p>
                           <?php } else { ?>
                              <a href="API/login.php" class="btn">Login <i class="fa-solid fa-lock"></i></a>
                           <?php } 
                        } else {
                           echo "<span class='admin-info'>Admin can manage events from the Dashboard.</span>";
                        }
                        ?>
                     </div>
                  </div>
